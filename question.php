...
<body>
    ...
    <form action="" method="POST">
        ...
        <div>
            <input class="block h-12 mb-2 ml-auto mr-auto text-white shadow-md w-52 sm:w-64 bg_secondary_btn md:w-72 rounded-2xl" type="submit" value="Voeg antwoord toe">
        </div>
        <div>
